...
<p>How should you respond?</p>`,
      ...
      "2": {
        ...
        `, 
        options: [
          { text: `Hold a memorial service at the hospital, in a worship space. A small group of senior hospital leaders and staff have asked that Mario’s memorial service be held at the hospital in the worship space. They believe that each person who died that day should be remembered.”`, conditions: {type: null, command: "NEXT", index: null}, feedback: `This isn't a bad choice, but there is a better one. Consider another option.` },
          { text: `Hold a memorial service off campus at a nearby church. Some senior hospital leaders and staff have asked that the memorial service be held off-site at a nearby church, so that anyone who wants to avoid the service doesn’t have to pass it during their work day.`, conditions: {type: null, command: "NEXT", index: null}, feedback: `This choice balances the needs of most of the stakeholders by holding a service for Mario, but not bringing that service into the space of the hospital. This choice avoids retraumatizing members of the hospital community, while still holding firm in the hospital’s values of “caring for the people in our community at all stages of life, from beginning to end.”` },
          { text: `Don’t hold a memorial service for Mario at all. Several senior hospital leaders and staff are adamantly opposed to holding a memorial service for Mario that’s affiliated with the hospital at all. They don’t want to give him any notoriety for this tragedy.`, conditions: {type: null, command: "NEXT", index: null}, feedback: `This is not the best choice. Consider another option.` },
          { text: `Hold a memorial service at the hospital, at the site of the shooting. A small group of hospital staff have voiced their desire to hold Mario’s memorial service at the site of the shooting, to hold the pain of the violence that all suffered on that day.`, conditions: {type: null, command: "NEXT", index: null}, feedback: `This is not the best choice. Consider another option.` },
    ...
    "3": {
        question: `<p>The final decision was for the hospital to host all three memorial services. Those for Hugo and Kelly were held on campus. The service for Mario took place off campus, away from the hospital, at a local church. You attended and spoke at his service. </p>`,
        options: [ 
